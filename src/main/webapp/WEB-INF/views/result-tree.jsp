	...
	<div class="section no-pad-bot" id="index-banner">
		<div class="row ">
			...
			<div class="hidden">
				...
				<fieldset>
					<legend>Show</legend>
					<input id="showArrayNode" type="checkbox" value="showArrayNode"
						checked>Array Node&nbsp;&nbsp; <input id="showLinkName"
						type="checkbox" value="showLinkName" checked>Link
					Name&nbsp;&nbsp; <input id="showColumn0" type="checkbox"
						value="showColumn0" checked>Column 1&nbsp;&nbsp; <input
						id="showColumn1" type="checkbox" value="showColumn1" checked>Column
					2&nbsp;&nbsp;
				</fieldset>

				<fieldset>
					<legend>Max Length</legend>
					<label>Column 1: <input id="maxNameLen" type="number"
						min="1" max="256" step="10" size="3" value="32">
					</label> <label>Column 2: <input id="maxValueLen" type="number"
						min="1" max="256" step="10" size="3" value="32">
					</label>
				</fieldset>
			</div>
