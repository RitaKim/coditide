...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/css/materialize-custom-ide.css"
	media="screen,projection" />
...
<body>
	<div id="wrapper" class="row">
		<div id="header" class="center grey lighten-2">
			<img id="logo"
				src="${pageContext.request.contextPath}/assets/image/0629_LOGO_FINAL_brown.gif">
		</div>
		<div id="navbar" class="col s4 grey darken-2">
			<div class="row">
				<div id="tabs" class="col s12 grey darken-2">
					<ul id="select-problem" class="tabs">
						<li class="tab col s3 grey darken-2 white-text"><a
							class="active" href="#task1" onclick="select(1)">Task1</a></li>
						<c:forEach var="no" begin="2" end="${problemInfoList.size()}"
							step="1">
							<li class="tab col s3 grey darken-2 white-text"><a
								href="#task${no}" onclick="select(${no})">Task${no}</a></li>
						</c:forEach>
					</ul>
				</div>
				<c:forEach items="${problemInfoList}" var="problemInfoVo"
					varStatus="status">
					<div id="task${status.count}"
						class="col s12 grey darken-2 white-text">
							...
							<div id="top-bar" class="row">
								...
								<div class="input-field col s2 no-padding">
									<select id="select-language" name="language"
										onchange="select_editor(current_k, this.value);">
				...
				<div class="col s12 grey darken-3">
					<div class="row">
						<div id="terminal" class="col s12 grey darken-4 selectable">
							<c:forEach begin="1" end="${problemInfoList.size()}"
								varStatus="status">
								<div>
									<h6 class="white-text">[Task ${status.index} output]</h6>
									<div id="terminal-${status.index}" class="white-text">output
										will be appended here</div>
								</div>
							</c:forEach>
						</div>
					</div>
	...
	<script src="${pageContext.request.contextPath }/assets/ace/ace.js"
		type="text/javascript" charset="utf-8"></script>
	<script
		src="${pageContext.request.contextPath }/assets/js/jquery.simple.timer.js"
		type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/js/jquery.spotlight.js"
		type="text/javascript" charset="utf-8"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath }/assets/js/jquery.spotlight.js"
		type="text/javascript" charset="utf-8"></script>
	<script src="${pageContext.request.contextPath }/assets/js/ide.js"
		type="text/javascript" charset="utf-8"></script>
	<script
		src="${pageContext.request.contextPath }/assets/js/test_page.js"
		type="text/javascript" charset="utf-8"></script>
